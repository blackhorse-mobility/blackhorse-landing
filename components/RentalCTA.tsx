...
export default function RentalCTA({ onGetStarted }: RentalCTAProps) {
  return (
    <section className="w-full bg-white px-6 py-12 md:py-24 md:px-16 flex font-display justify-center">
      ...
      >
        <div className="relative z-10 flex flex-col items-start justify-center p-10 md:p-16 lg:px-20 lg:py-24 lg:w-2/3">
          ...
          <p
            className={`text-[#8C98A4] text-[16px] md:text-[18px] leading-relaxed max-w-[420px] mb-10 ${manrope.className}`}
          >
            Access steady, verified corporate demand and manage your operations
